...
# Fix duplicate columns from double-join
SFEI_results <- SFEI_results %>%
  rename(
    Range_Size = Range_Size.x,
    Fishing_Data_Coverage = Fishing_Data_Coverage.x,
    IUCN = IUCN.x,
    FUSE = FUSE.x,
    EDGE2 = EDGE2.x
  ) %>%
...
# Verify
cat("Columns after cleanup:\n")
print(names(SFEI_results))
